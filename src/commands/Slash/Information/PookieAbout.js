...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            .setAuthor({ name: `${interaction.guild.members.me.displayName} About Panel!`, iconURL: interaction.guild.iconURL({ dynamic: true }) || "https://i.postimg.cc/SRGS9TGz/mainlogo.png" })
            ...
            .addFields([
                ...
                { name: `${emoji.custom_emoji.owner} Creator`, value: `\`\`\`x.tros\`\`\``, inline: true },
                { name: `${emoji.custom_emoji.admin} Team`, value: `\`\`\`Pookie Musix\`\`\``, inline: true },
            ])
            .setColor(client.color)
            .setFooter({ text: `Pookie Musix !`, iconURL: client.user.displayAvatarURL({ dynamic: true }) || "https://i.postimg.cc/SRGS9TGz/mainlogo.png" })
            .setTimestamp();
