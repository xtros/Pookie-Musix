...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            .setAuthor({ name: `Queue List`, iconURL: interaction.guild.iconURL({ dynamic: true }) || "https://i.postimg.cc/SRGS9TGz/mainlogo.png" })
            .setColor(client.color)
            .setThumbnail(npSong.image || "https://i.postimg.cc/SRGS9TGz/mainlogo.png")
            .setDescription(
            ...
            .setFooter({
                ...
                iconURL: interaction.user.displayAvatarURL({ dynamic: true }) || "https://i.postimg.cc/SRGS9TGz/mainlogo.png",
            })
            .setTimestamp();
